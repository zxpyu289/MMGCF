...
class CondDataset(Dataset):
    def __init__(self, full_nodes, full_edges,  full_smi ):#frag_nodes, frag_edges,linker_len, exit_point, full_smi , clique):
...
class TrainCondDataset(Dataset):
    def __init__(self, full_nodes, full_edges, full_smi):
        self.n_molecule = full_nodes.shape[0]
        self.full_nodes = full_nodes
        self.full_edges = full_edges
        self.full_smi = full_smi

        self.atom_list ={0: 'Br', 1: 'C', 2: 'Cl', 3: 'F', 4: 'H', 5: 'I', 6: 'N', 7: 'N', 8: 'N', 9: 'O', 10: 'O', 11: 'S', 12: 'S', 13: 'S'}
        self.max_size = self.full_nodes.shape[1] # N
        self.node_dim = len(self.atom_list) #14
